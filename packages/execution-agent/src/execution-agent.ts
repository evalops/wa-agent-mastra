...
import type { ExecutionConfig, TaskRequest, ExecutionResponse, TriggerDefinition, SearchResult } from './types';
...
export class ExecutionAgent {
  ...
  async executeTask(request: TaskRequest): Promise<ExecutionResponse> {
    try {
  ...
  private analyzeTaskType(goal: string): string {
  ...
  private async executeSearch(request: TaskRequest): Promise<ExecutionResponse> {
  ...
  private async executeEmailTask(request: TaskRequest): Promise<ExecutionResponse> {
  ...
  private async executeCalendarTask(request: TaskRequest): Promise<ExecutionResponse> {
  ...
  private async executeAutomationTask(request: TaskRequest): Promise<ExecutionResponse> {
  ...
  private async executeParallelTasks(request: TaskRequest): Promise<ExecutionResponse> {
  ...
  private async executeGenericTask(request: TaskRequest): Promise<ExecutionResponse> {
  ...
  // Helper methods
  private extractSearchTerms(goal: string): string[] {
  ...
  private async searchWithTool(toolName: string, terms: string[], sessionId: string): Promise<SearchResult[]> {
  ...
  private async searchMemory(terms: string[], sessionId: string): Promise<SearchResult[]> {
  ...
  private extractTriggerCondition(goal: string): string {
  ...
  private extractTriggerAction(goal: string): string {
  ...
  private splitIntoParallelTasks(goal: string): string[] {
  ...
  // Trigger management
  async createTrigger(definition: Omit<TriggerDefinition, 'id' | 'created'>): Promise<string> {
    const triggerId = `trigger-${Date.now()}`;
    const trigger: TriggerDefinition = {
      ...definition,
      id: triggerId,
  ...
  async getTriggers(sessionId?: string): Promise<TriggerDefinition[]> {
